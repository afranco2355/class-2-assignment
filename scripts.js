...
function showDreamDog() {
  var dreamDogImageURL = "URL_OF_YOUR_DREAM_DOG_IMAGE";
  var dreamDogImage = document.getElementById("dream-dog-image");
  dreamDogImage.src = dreamDogImageURL;
  dreamDogImage.style.display = "block";
}
